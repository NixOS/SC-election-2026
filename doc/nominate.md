...
Be aware of the [timeline](../README.md#timeline).
...
2. Ensure that you're in the [@NixOS/voters-2026 team](https://github.com/orgs/NixOS/teams/voters-2026)
...
3. Ensure that your [email is correct](./email.md) and
   ...
   This is easiest [directly on GitHub](https://github.com/NixOS/SC-election-2026/new/main?filename=candidates/%3Cgithub%20handle%3E.md).
...
3. Ensure that both you and the nominee are in the [@NixOS/voters-2026 team](https://github.com/orgs/NixOS/teams/voters-2026)
   and otherwise [request voter exceptions](./exception-request.md).
4. Ensure that your [voter email is correct](./email.md) and
   create a PR to add an *empty* `candidates/<github handle>.md` file matching the nominee's GitHub handle.
   This is easiest [directly on GitHub](https://github.com/NixOS/SC-election-2026/new/main?filename=candidates/%3Cgithub%20handle%3E.md).
